...
// ─── Projects (7 items) ───
const PROJECTS = [
  { id: uid(301), code: 'PRJ-2024-001', name: 'فلل الساحل الشمالي', client: 'شركة بالم هيلز', buildings: [{ id: uid(3011), name: 'مبنى أ', floors: [{ id: uid(7001), name: 'طابق 1', source: 'local' as const }, { id: uid(7002), name: 'طابق 2', source: 'local' as const }, { id: uid(7003), name: 'طابق 3', source: 'import' as const }] }, { id: uid(3012), name: 'مبنى ب', floors: [{ id: uid(7004), name: 'طابق 1', source: 'local' as const }, { id: uid(7005), name: 'طابق 2', source: 'import' as const }] }], createdAt: today(-90), updatedAt: today() },
  { id: uid(302), code: 'PRJ-2024-002', name: 'برج الأعمال المركزي', client: 'شركة طلعت مصطفى', buildings: [{ id: uid(3021), name: 'البرج الرئيسي', floors: [{ id: uid(7006), name: 'طابق 1', source: 'local' as const }, { id: uid(7007), name: 'طابق 2', source: 'local' as const }, { id: uid(7008), name: 'طابق 3', source: 'local' as const }, { id: uid(7009), name: 'طابق 4', source: 'import' as const }, { id: uid(7010), name: 'طابق 5', source: 'import' as const }] }], createdAt: today(-80), updatedAt: today() },
  { id: uid(303), code: 'PRJ-2024-003', name: 'كمبوند جاردينيا', client: 'شركة إعمار', buildings: [{ id: uid(3031), name: 'مبنى 1', floors: [{ id: uid(7011), name: 'طابق أرضي', source: 'local' as const }, { id: uid(7012), name: 'طابق 1', source: 'local' as const }, { id: uid(7013), name: 'طابق 2', source: 'import' as const }] }, { id: uid(3032), name: 'مبنى 2', floors: [{ id: uid(7014), name: 'طابق أرضي', source: 'local' as const }, { id: uid(7015), name: 'طابق 1', source: 'local' as const }] }], createdAt: today(-75), updatedAt: today() },
  { id: uid(304), code: 'PRJ-2024-004', name: 'منتجع هيلتون الغردقة', client: 'فنادق هيلتون', buildings: [{ id: uid(3041), name: 'المبنى الرئيسي', floors: [{ id: uid(7016), name: 'طابق 1', source: 'import' as const }, { id: uid(7017), name: 'طابق 2', source: 'import' as const }, { id: uid(7018), name: 'طابق 3', source: 'local' as const }] }, { id: uid(3042), name: 'المبنى الجنوبي', floors: [{ id: uid(7019), name: 'طابق 1', source: 'local' as const }, { id: uid(7020), name: 'طابق 2', source: 'local' as const }] }], createdAt: today(-70), updatedAt: today() },
  { id: uid(305), code: 'PRJ-2024-005', name: 'مجمع مدارس النخبة', client: 'مؤسسة التعليم الدولي', buildings: [{ id: uid(3051), name: 'مبنى الصف الابتدائي', floors: [{ id: uid(7021), name: 'طابق أرضي', source: 'local' as const }, { id: uid(7022), name: 'طابق 1', source: 'local' as const }] }, { id: uid(3052), name: 'مبنى الصف الثانوي', floors: [{ id: uid(7023), name: 'طابق أرضي', source: 'local' as const }, { id: uid(7024), name: 'طابق 1', source: 'import' as const }, { id: uid(7025), name: 'طابق 2', source: 'import' as const }] }], createdAt: today(-65), updatedAt: today() },
  { id: uid(306), code: 'PRJ-2024-006', name: 'مستشفى الأمل التخصصي', client: 'وزارة الصحة', buildings: [{ id: uid(3061), name: 'المبنى الطبي', floors: [{ id: uid(7026), name: 'الطابق الأرضي', source: 'local' as const }, { id: uid(7027), name: 'طابق 1', source: 'import' as const }, { id: uid(7028), name: 'طابق 2', source: 'import' as const }, { id: uid(7029), name: 'طابق 3', source: 'import' as const }] }], createdAt: today(-60), updatedAt: today() },
  { id: uid(307), code: 'PRJ-2024-007', name: 'مول الشرق التجاري', client: 'شركة القاهرة للتطوير', buildings: [{ id: uid(3071), name: 'المول الرئيسي', floors: [{ id: uid(7030), name: 'الدور الأرضي', source: 'local' as const }, { id: uid(7031), name: 'طابق 1', source: 'local' as const }, { id: uid(7032), name: 'طابق 2', source: 'import' as const }] }, { id: uid(3072), name: 'المول الغربي', floors: [{ id: uid(7033), name: 'الدور الأرضي', source: 'local' as const }, { id: uid(7034), name: 'طابق 1', source: 'local' as const }] }], createdAt: today(-55), updatedAt: today() },
];
...
const BOXES = [
  { id: uid(901), num: 'BOX-2024001', name: 'صندوق BOX-2024001', type: BOX_TYPES[0], wgt: '120', bldg: 'أ', flr: '1', notes: 'عناية خاصة', prods: [{ id: uid(601), name: 'وحدة خزانة ملابس كاملة', code: 'PROD-DR-001', qty: 2 }, { id: uid(602), name: 'وحدة خزانة أحذية', code: 'PROD-DR-002', qty: 1 }], containerId: uid(401), createdAt: today(-28) },
  { id: uid(902), num: 'BOX-2024002', name: 'صندوق BOX-2024002', type: BOX_TYPES[1], wgt: '85', bldg: 'أ', flr: '2', notes: undefined, prods: [{ id: uid(603), name: 'مطبخ أمريكي مدمج', code: 'PROD-KT-001', qty: 1 }], containerId: uid(401), createdAt: today(-26) },
  { id: uid(903), num: 'BOX-2024003', name: 'صندوق BOX-2024003', type: BOX_TYPES[2], wgt: '200', bldg: '1', flr: '1', notes: 'قابل للكسر', prods: [{ id: uid(605), name: 'وحدة حمام رئيسية', code: 'PROD-BR-001', qty: 2 }, { id: uid(606), name: 'وحدة حمام ضيوف', code: 'PROD-BR-002', qty: 1 }], containerId: uid(402), createdAt: today(-22) },
  { id: uid(904), num: 'BOX-2024004', name: 'صندوق BOX-2024004', type: BOX_TYPES[0], wgt: '150', bldg: '1', flr: '2', notes: undefined, prods: [{ id: uid(607), name: 'وحدة تلفزيون معيشة', code: 'PROD-LV-001', qty: 2 }], containerId: uid(403), createdAt: today(-18) },
  { id: uid(905), num: 'BOX-2024005', name: 'صندوق BOX-2024005', type: BOX_TYPES[3], wgt: '75', bldg: 'ب', flr: '1', notes: undefined, prods: [{ id: uid(608), name: 'طاولة قهوة مركزية', code: 'PROD-LV-002', qty: 3 }], containerId: uid(403), createdAt: today(-16) },
  { id: uid(906), num: 'BOX-2024006', name: 'صندوق BOX-2024006', type: BOX_TYPES[1], wgt: '180', bldg: '1', flr: '1', notes: 'عناية خاصة', prods: [{ id: uid(609), name: 'سرير ماستر مع لوح رأسي', code: 'PROD-BD-001', qty: 1 }, { id: uid(610), name: 'سرير أطفال مزدوج', code: 'PROD-BD-002', qty: 1 }], containerId: uid(404), createdAt: today(-14) },
  { id: uid(907), num: 'BOX-2024007', name: 'صندوق BOX-2024007', type: BOX_TYPES[2], wgt: '95', bldg: '1', flr: 'أرضي', notes: undefined, prods: [{ id: uid(611), name: 'مكتب إداري مع خزانة', code: 'PROD-OF-001', qty: 2 }], containerId: uid(405), createdAt: today(-10) },
  { id: uid(908), num: 'BOX-2024008', name: 'صندوق BOX-2024008', type: BOX_TYPES[0], wgt: '60', bldg: '2', flr: '1', notes: undefined, prods: [{ id: uid(612), name: 'وحدة أرفف مكتبية', code: 'PROD-OF-002', qty: 3 }], containerId: uid(405), createdAt: today(-8) },
  { id: uid(909), num: 'BOX-2024009', name: 'صندوق BOX-2024009', type: BOX_TYPES[3], wgt: '220', bldg: '1', flr: '1', notes: 'ثقيلة', prods: [{ id: uid(613), name: 'طاولة طعام 8 كراسي', code: 'PROD-DN-001', qty: 1 }], containerId: uid(406), createdAt: today(-6) },
  { id: uid(910), num: 'BOX-2024010', name: 'صندوق BOX-2024010', type: BOX_TYPES[1], wgt: '110', bldg: '1', flr: '2', notes: undefined, prods: [{ id: uid(614), name: 'بوفيه خدمة جانبي', code: 'PROD-DN-002', qty: 2 }], containerId: uid(406), createdAt: today(-5) },
  { id: uid(911), num: 'BOX-2024011', name: 'صندوق BOX-2024011', type: BOX_TYPES[2], wgt: '45', bldg: '1', flr: 'الدور الأرضي', notes: undefined, prods: [{ id: uid(615), name: 'خزانة أحذية مدخل', code: 'PROD-EN-001', qty: 4 }], containerId: uid(407), createdAt: today(-3) },
  { id: uid(912), num: 'BOX-2024012', name: 'صندوق BOX-2024012', type: BOX_TYPES[0], wgt: '130', bldg: 'ب', flr: '1', notes: undefined, prods: [{ id: uid(601), name: 'وحدة خزانة ملابس كاملة', code: 'PROD-DR-001', qty: 1 }, { id: uid(604), name: 'جزيرة مطبخ مركزية', code: 'PROD-KT-002', qty: 1 }], containerId: uid(407), createdAt: today(-2) },
];
